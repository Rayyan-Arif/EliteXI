"use client";
<<<<<<< HEAD
import UserMatchSkeleton from '@/app/components/userComponents/UserMatchSkeleton';
=======
...
<<<<<<< HEAD
                localStorage.setItem("match", JSON.stringify({...m, has_game_started: data.data.match}));
=======
>>>>>>> e20b911618b407610e2432ed7712fac05003b0fa
            } catch(err){
                ...
                <section className="flex-1 min-h-0 flex flex-col px-6 py-5">
                    ...
                    >
...

                        {
                            ...
                            : <p className='text-center text-2xl'>Timeline appears here.</p>
                        }
                        </div>
                    </div>
                </section>
